...
<body>
	<div class="welcome">
		<p>{{ $test or 'pas de jeu en cours' }}</p>
		...
		<h1>Bienvenue sur la version Laravel du jeu Vendredi de Friedmann Friese</h1>
		<p></p>
		{{ HTML::linkAction('VendrediController@getCreate', 'Niveau 1', array('lvl' => 1), array('class' => 'btn btn-success')) }}
		{{ HTML::linkAction('VendrediController@getCreate', 'Niveau 2', array('lvl' => 2), array('class' => 'btn btn-info')) }}
		{{ HTML::linkAction('VendrediController@getCreate', 'Niveau 3', array('lvl' => 3), array('class' => 'btn btn-danger')) }}
		{{ HTML::linkAction('VendrediController@getCreate', 'Niveau 4', array('lvl' => 4), array('class' => 'btn btn-warning')) }}
	</div>
