...
<body>
	<div class="welcome">
		...
		<p></p>
		{{ HTML::linkAction('VendrediController@getIndex', 'Niveau 1', array('lvl' => 1), array('class' => 'btn btn-success')) }}
		{{ HTML::linkAction('VendrediController@getIndex', 'Niveau 2', array('lvl' => 2), array('class' => 'btn btn-info')) }}
		{{ HTML::linkAction('VendrediController@getIndex', 'Niveau 3', array('lvl' => 3), array('class' => 'btn btn-danger')) }}
		{{ HTML::linkAction('VendrediController@getIndex', 'Niveau 4', array('lvl' => 4), array('class' => 'btn btn-warning')) }}
	</div>
